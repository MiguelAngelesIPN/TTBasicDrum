 ...
 */
public class VisualizadorAlumno extends javax.swing.JFrame {
     ...
     */
    public VisualizadorAlumno() {
        initComponents();
    }
    public VisualizadorAlumno(Conexion conexion,Usuario usuario, String ubicacion) throws SQLException{
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizadorAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new VisualizadorAlumno().setVisible(true);
        });
    }
