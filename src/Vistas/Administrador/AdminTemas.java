 ...
 */
public class AdminTemas extends javax.swing.JFrame {
    ...
    public AdminTemas(Conexion conexion,Usuario usuario) throws SQLException{
        initComponents();
        this.conexion=conexion;
        this.usuario=usuario;
        LlenarTabla("select idTema,nombre,descripción from tema");
    }
    
    public void LlenarTabla(String consulta) throws SQLException{
        ResultSet resultado=conexion.Consultar(consulta);
        DefaultTableModel dtm=new DefaultTableModel();
        dtm.addColumn("IdTema");
    ...
    private void initComponents() {
        ...
        jButton2.setText("Editar descripción");
        ...
        jButton4.setText("Eliminar tema seleccionado");
        jButton4.setActionCommand("Eliminar tema seleccionado");
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        // TODO add your handling code here:
        String comando="select idTema, nombre, descripción from tema where nombre like '%"+jTextField1.getText()+"%' or descripción like '%"+jTextField1.getText()+"%'";
        try {
            LlenarTabla(comando);
        } catch (SQLException ex) {
            Logger.getLogger(AdminTemas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(fila!=-1){
            ...
            try{
                String nvoNombre=JOptionPane.showInputDialog("Ingresa el nuevo nombre de tema");
                if(nvoNombre.equals("")){
                    JOptionPane.showMessageDialog(this, "Debe ingresar un nombre");
                }
                else{
                    String comando="update tema set nombre='"+nvoNombre+"' where idTema="+id;
                    try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fila!=-1){
            try{
                int id=(int) jTable1.getValueAt(fila, 0);
                String descripcion=JOptionPane.showInputDialog(this, "Ingrese la nueva descripción del tema:");
                String comando="update tema set descripción='"+descripcion+"' where idTema="+id;
                conexion.Actualizar(comando);
                JOptionPane.showMessageDialog(this, "Información actualizada con éxito.");
                LlenarTabla("select idTema,nombre,descripción from tema");
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(fila!=-1){
            try{
                int id=(int) jTable1.getValueAt(fila, 0);
                int opcion=(int)JOptionPane.showConfirmDialog(this, "¿Esta seguro que desea eliminar el tema "+jTable1.getValueAt(fila, 1)+"?");
                System.out.println(opcion);
                if(opcion==0){
                    String comando="delete from tema where idTema="+id;
                    conexion.Actualizar(comando);
                    JOptionPane.showMessageDialog(this,"Tema eliminado con éxito.");
                    LlenarTabla("select idTema,nombre,descripción from tema");
                }
            }
            catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminTemas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminTemas().setVisible(true);
            }
        });
    }
