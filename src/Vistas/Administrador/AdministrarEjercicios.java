 ...
 */
public class AdministrarEjercicios extends javax.swing.JFrame {
     ...
     */
    public AdministrarEjercicios() {
        initComponents();
    }

    AdministrarEjercicios(Conexion conexion, Usuario usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar ejercicios");
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        try {
            // TODO add your handling code here:
            AdminEjercicios vista=new AdminEjercicios(conexion,usuario);
            vista.setVisible(true);
            dispose();
        } catch (SQLException ex) {
            Logger.getLogger(AdministrarEjercicios.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministrarEjercicios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministrarEjercicios().setVisible(true);
            }
        });
    }
